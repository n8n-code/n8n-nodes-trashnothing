...
export class TrashnothingApi implements ICredentialType {
	name = 'N8nDevTrashnothingApi';

	displayName = 'trashnothing API';

	icon: Icon = { light: 'file:../nodes/Trashnothing/trashnothing.png', dark: 'file:../nodes/Trashnothing/trashnothing.dark.png' };
	...
	properties: INodeProperties[] = [
		{
			...
			required: true,
			placeholder: 'https://trashnothing.com/api/v1.3',
			description: 'The base URL of your trashnothing API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
